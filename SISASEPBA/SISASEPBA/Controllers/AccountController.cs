...
namespace SISASEPBA.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            var dt = _servicio.Login(model.Email, model.Password);
            ...
            if (dt.IsSuccess)
            {
                ...
                claims.AddRange(new List<Claim>
                {
                    ...
                    new Claim(ClaimTypes.Name,model.Email.ToUpper()),
                });

                var id = new ClaimsIdentity(claims, DefaultAuthenticationTypes.ApplicationCookie);
                HttpContext.GetOwinContext().Authentication.SignIn(new AuthenticationProperties { IsPersistent = model.RememberMe }, id);
