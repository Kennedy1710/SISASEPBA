...
namespace SISASEPBAWs.CapaLogica
{
    ...
    {
        #region
        private const string SpConexion = "SP_Grupos";
        ...
        public static Response Procesar(Grupo obj)
        {
            try
            {
                ...
                else
                {
                    ...
                    comando.Parameters.AddWithValue("@@IdGrupo", obj.IdGrupo);
        ...
        public static DataSet Consultar(Grupo obj)
        {
            try
            {
                var comando = new SqlCommand();
