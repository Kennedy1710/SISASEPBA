...
{
    public class ClsEmpleadoLicencia
    {
        #region Constantes
        private const string SpConexion = "SP_EmpleadoLicencia";
        private const string SpConexion2 = "SP_TipoLicencia";
        ...
        public static Response Procesar(EmpleadoLicencia obj)
        {
            try
            {
                ...
                else
                {
                    ...
                    comando.Parameters.AddWithValue("@@IdEmpleadoLicencia", obj.IdEmpleadoLicencia);
        ...
        public static DataSet Consultar(EmpleadoLicencia obj)
        {
            try
            {
                var comando = new SqlCommand();
