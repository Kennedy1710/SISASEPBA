...
{
    public class ClsControlVacacional
    {
        #region Constantes
        private const string SpConexion = "SP_Control_Vacacional";
        ...
        public static Response Procesar(ControlVacacional obj)
        {
            try
            {
                ...
                else
                {
                    ...
                    comando.Parameters.AddWithValue("@@DiasAcuMes", obj.DiasAcuMes);
                    comando.Parameters.AddWithValue("@@DiasRestados", obj.DiasRestados);
                    comando.Parameters.AddWithValue("@@IncluirSabados", obj.IncluirSabados);
                    comando.Parameters.AddWithValue("@@IncluirDomingos", obj.IncluirDomingos);
        ...
        public static DataSet Consultar(ControlVacacional obj)
        {
            try
            {
                var comando = new SqlCommand();
