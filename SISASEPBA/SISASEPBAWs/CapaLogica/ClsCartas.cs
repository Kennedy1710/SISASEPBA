...
namespace SISASEPBAWs.CapaLogica
{
    ...
    {
        #region
        private const string SpConexion = "SP_Cartas";
        ...
        public static Response ProcesarCartas(Cartas obj)
        {
            try
            {
                ...
                else
                {
                    ...
                    comando.Parameters.AddWithValue("@@IdCarta", obj.IdCarta);
                    ...
                    comando.Parameters.AddWithValue("@@CantidadImpresiones", obj.CantidadImpresiones);
        ...
        public static DataSet ConsultarCartas(Cartas obj)
        {
            try
            {
                var comando = new SqlCommand();
